...
class StoreEdit extends PureComponent {
  state = {
    width: '100%',
  };
  common = {
    ...
    return (
      ...
      >
        <Form layout="vertical" hideRequiredMark>
          <Card loading={loading} title="基本信息" className={styles.card} bordered={false}>
          ...
          <Card loading={loading} title="法人信息" className={styles.card} bordered={false}>
          ...
          <Card loading={loading} title="联系人信息" className={styles.card} bordered={false}>
